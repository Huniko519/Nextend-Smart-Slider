...
class ArrowImage extends AbstractWidgetArrow {
    ...
    public function renderFields($container) {
        ...
        new FloatToPercent($row4, 'widget-arrow-responsive-desktop', n2_('Desktop size'), '');

        new FloatToPercent($row4, 'widget-arrow-responsive-tablet', n2_('Tablet size'), '');

        new FloatToPercent($row4, 'widget-arrow-responsive-mobile', n2_('Mobile size'), '');
