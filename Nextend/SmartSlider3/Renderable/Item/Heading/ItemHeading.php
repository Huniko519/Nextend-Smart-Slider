...
class ItemHeading extends AbstractItem {
    ...
    public function renderFields($container) {
        ...
        new SplitTextAnimation($splitText, 'split-text-animation-in', n2_('Incoming'), '', array(
            ...
            'preview'             => '<div style="width:{$(nextend.activeLayer.layer[0]).width();}px;"><div class="{styleClassName}"><span class="{fontClassName}">{$(\'#item_headingheading\').val().replace(/\\n/g, "<br />");}</span></div></div>',
        ...
        $transformOrigin = new Mixed($splitText, 'split-text-transform-origin', n2_('Transform origin'), '50|*|50|*|0');
