    ...
    if (get_option('ss3_bf_2020') != '1') {
        ...
        add_action('admin_notices', function () {
            ...
            <div class="notice notice-info is-dismissible" data-ss3dismissable="ss3_bf_2020" style="display:grid;grid-template-columns: 100px auto;padding-top: 25px; padding-bottom: 22px;">
                ...
                <h3 style="margin:0;">Need more license? Upgrade your plan and save up to 40%</h3>
                <p style="margin:0 0 2px;">Don't miss out on our biggest sale of the year! Upgrade your
                    <b>Smart Slider 3 Pro plan</b> with <b>40% OFF</b>! Limited time offer expires on December 1.</p>
                <p style="margin:0;">
                    <a class="button button-primary" href="https://secure.nextendweb.com/?coupon=SAVE4020&utm_source=wpprou&utm_medium=wp&utm_campaign=bf20" target="_blank">
                        Buy Now</a>
